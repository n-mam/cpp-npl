...
nmam@vm:~/cpp-np-lib/build$ export OPENSSL_ROOT_DIR=/home/nmam/vcpkg/installed/x64-linux
nmam@vm:~/cpp-np-lib/build$ export OPENSSL_INCLUDE_DIR=/home/nmam/vcpkg/installed/x64-linux/include
```
```sh
mkdir build
cd build
